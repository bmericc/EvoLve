...
<div class="entry-caption"><?php if ( !empty( $post->post_excerpt ) ) the_excerpt(); ?></div>
 ...
 <?php if ( have_posts() ) : ?>
        ...
        { ?>  <h1 class="entry-title"><?php if ( get_the_title() ){ the_title(); }else{ _e( 'Untitled', 'evolve' );  } ?></h1>
					...
					<!--BEGIN .entry-meta .entry-header-->
					<div class="entry-meta entry-header">
          <a href="<?php the_permalink() ?>"><span class="published"><?php the_time('dM'); ?><br /><strong><?php the_time('Y'); ?></strong></span></a>
...
similar_posts(); } ?>  
 ...
 ----------------------->
    ...
    <h2 class="page-title archive-title"><?php _e( 'Posts in category', 'evolve' ); ?> <span id="category-title"><?php single_cat_title(); ?></span></h2>
       ...
       <h2 class="page-title search-title"><?php _e( 'Search results for', 'evolve' ); ?> <?php echo '<span class="search-term">'.$s.'</span>'; ?></h2>
...
echo truncate($title, 40, '...'); }else{ _e( 'Untitled', 'evolve' );  }
 ?></a> 
...
echo truncate($postexcerpt, 350, ' [...]');
 ?>
          ...
          <span class="read-more">
           <a href="<?php the_permalink(); ?>"><?php _e('READ MORE', 'evolve' ); ?></a> &raquo;
           </span>
        ...
        <?php if (is_search()) { ?>
        	...
        	<!--BEGIN #post-0-->
				<div id="post-0" class="<?php semantic_entries(); ?>">
					<h1 class="entry-title"><?php _e( 'Your search for', 'evolve' ); ?> "<?php echo "$s"; ?>" <?php _e( 'did not match any entries', 'evolve' ); ?></h1>
